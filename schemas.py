...
==========================
All Pydantic output models shared across tools.
...
# ---------------------------------------------------------------------------
# Shared section / filing primitives
# ---------------------------------------------------------------------------
...
class TrendPoint(BaseModel):
    """Materiality snapshot for a single filing in the trend timeline."""
    filing_date:         str
    accession_number:    str
    risk_materiality:    str    # "low" | "moderate" | "high" | "critical" | "unknown"
    mda_materiality:     str
...
class TrendSignalAppearance(BaseModel):
    """A risk signal that appeared or disappeared at a specific filing."""
    signal:           str
    filing_date:      str
    accession_number: str
...
class TrendSummary(BaseModel):
    trajectory:            str    # "improving" | "deteriorating" | "stable" | "insufficient_data"
...
class RiskCategoryDetail(BaseModel):
    """Signals and excerpts for a single risk domain."""
